            ...
            <div class="box box-warning">
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        {php_open_tag_echo} form_open(base_url('administrator/manage-form/{table_name}/edit_save/'.$this->uri->segment(5)), [
...
<script>
    ...
    ?>
        ...
        $('#{table_name}_<?= $field_all[$input]['input_name']; ?>_galery').fineUploader({
            ...
            request: {
                endpoint: BASE_URL + '/administrator/manage-form/{table_name}/upload_<?= $field_all[$input]['input_name']; ?>_file',
                params: params
            },
            deleteFile: {
                enabled: true,
                endpoint: BASE_URL + '/administrator/manage-form/{table_name}/delete_<?= $field_all[$input]['input_name']; ?>_file'
            },
            thumbnails: {
                placeholders: {
            ...
            session: {
                endpoint: BASE_URL + 'administrator/manage-form/{table_name}/get_<?= $field_all[$input]['input_name']; ?>_file/{php_open_tag_echo} ${table_name}->{primary_key}; {php_close_tag}',
            ...
            callbacks: {
                ...
                onSubmit: function(id, name) {
                    ...
                    $.get(BASE_URL + '/administrator/manage-form/{table_name}/delete_<?= $field_all[$input]['input_name']; ?>_file/' + uuid);
                },
