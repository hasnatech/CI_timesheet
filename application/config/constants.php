...
defined('VERSION')              or define('VERSION', '3.3.1'); // highest automatically-assigned error code
...
defined('DISABLE_POPUP_RELATION')  or define('DISABLE_POPUP_RELATION', true);
defined('DISABLE_BULK_ACTION')  or define('DISABLE_BULK_ACTION', false);
defined('DISABLE_PDF_EXPORT')  or define('DISABLE_PDF_EXPORT', true);
