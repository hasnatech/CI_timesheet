...
CcPageElement.addField({
	...
	'onReady' : function (field) {
       ...
       $('#image_galery').fineUploader({
          ...
          request: {
              endpoint: BASE_URL + '/administrator/page/upload_image_file',
              params : params
          },
          deleteFile: {
              enabled: true, // defaults to false
              endpoint: BASE_URL + '/administrator/page/delete_image_file',
          },
          thumbnails: {
              placeholders: {
          ...
          callbacks: {
              ...
              onSubmit : function(id, name) {
                  ...
                  $.get(BASE_URL + '/administrator/page/delete_image_file/' + uuid);
              }
          }
      });
