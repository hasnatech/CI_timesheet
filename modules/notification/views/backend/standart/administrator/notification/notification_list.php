                           ...
                           <tbody id="tbody_notification">
                              <?php foreach ($notifications as $notification) : ?>
                                 <tr>
                                    ...
                                    <td><span class="list_group-content"><?= strip_tags($notification->content); ?></span></td>
   ...
   $(document).ready(function() {
      ...
      $('.table tbody tr').each(function() {
         ...
         (function() {
            ...
            var content = row.find('.list_group-content');
            var read = row.find('.list_group-read');

            if (read.html() == 0) {
               read.html('unread').wrap('<span class="badge"></span>');
            } else {
               read.html('read').wrap('<span class="badge"></span>');
            }
