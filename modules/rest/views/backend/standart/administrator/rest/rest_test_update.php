...
<form class="form-horizontal form-add" name="form_rest" id="form_rest" enctype="multipart/form-data" action="<?= base_url('api/'.$rest->table_name.'/update'); ?>" method="POST" >
 ...
 <table class="table table-responsive table table-bordered table-striped"  id="diagnosis_list">
   ...
   <table class="table table-responsive table table-bordered table-striped"  id="diagnosis_list">
      ...
      <?php $i=1; foreach ($rest_field as $row):  $i++; 
