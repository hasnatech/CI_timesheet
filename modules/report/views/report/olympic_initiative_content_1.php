...
<table border="1" cellpadding="1" cellspacing="1" style="width:500px">
	<tbody>
		...
		<tr>
			...
			<td style="text-align:center"><span style="font-size:12px">{{ olympic_cost_impact_fix.plan_impact_jan}}</span></td>
...
<table border="0" cellpadding="1" cellspacing="1" style="width:500px">
	<tbody>{% for file in olympic_file_repository %}
			<tr>
