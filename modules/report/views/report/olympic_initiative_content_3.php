...
<div id="print_here">
    ...
    <p class="mt-10">
        <img src="http://olympic.reinovasi.com/uploads/icon-report/serch.png" class="img-icon" />
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="">
                ...
                <div class="background-green long-text-overflow">{{ olympic_initiative.calculation_methods}}</div>
            </div>
        </div>
        <!-- <div class="col-sm-12">
            <div class="">
        ...
        <div class="col-sm-12">
            <div class="">
                ...
                <div class="background-green long-text-overflow">{{ olympic_initiative.challenge_and_constraints}}</div>
            </div>
        </div>
        <div class="col-sm-12">
            <div class="">
                <div class="title ">Opportunity for Next Improvement</div>
                <div class="background-green long-text-overflow">{{ olympic_initiative.opportunity_for_next_improvement}}</div>
            </div>
        </div>
        <div class="col-sm-12">
            <div class="">
                <div class="title ">Remark</div>
                <div class="background-green long-text-overflow">{{ olympic_initiative.remarks}}</div>
            </div>
        </div>
    </div>
    ...
    <p class="mt-10">
        <img src="http://olympic.reinovasi.com/uploads/icon-report/kalender.png" class="img-icon" />
        <span class="text-icon"><strong>Milestone</strong></span>
    </p>

    {% for milestone in olympic_milestone %} {% endfor %}

    <table border="1" cellpadding="1" cellspacing="1" class="tbl" style="border: none">
        <tbody>
            <tr>
    ...
    <p class="mt-10">
        <img src="http://olympic.reinovasi.com/uploads/icon-report/gepokan.png" class="img-icon" />
    ...
    <div class="ml-20">
        <div class="row">
            <div class="col-sm-12">
                <span class="title">Total Impact Verified : </span>
                $ <span id="value_total_impact_verified"></span></strong>
            </div>
        </div>
    </div>

    <table border="1" cellpadding="1" cellspacing="1" class="tbl" style="border: none; display: none">
    ...
    <p class="mt-10">
        <img src="http://olympic.reinovasi.com/uploads/icon-report/grup.png" class="img-icon" />
    ...
    <table border="0" cellpadding="1" cellspacing="1" width="100%" class="ml-20">
        <tbody>
            ...
            <tr>
                <td>
                    <img alt="" src="http://olympic.reinovasi.com/uploads/icon-report/user.png" class="img-icon-small" />&nbsp;
    ...
    <p class="mt-10">
        <img src="http://olympic.reinovasi.com/uploads/icon-report/folder.png" class="img-icon" />
    ...
    <table border="0" cellpadding="1" cellspacing="1" width="100%" class="ml-20">
        <tbody>
            ...
            <tr>
                <td>
                    <img alt="" src="http://olympic.reinovasi.com/uploads/icon-report/file.png" class="img-icon-small" />&nbsp;
